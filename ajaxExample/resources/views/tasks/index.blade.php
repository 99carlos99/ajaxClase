...
<script>
    function createTask(){
        ...
        .done(function(response){
            $('#description').val('');
            $('.table tbody').append('<tr><td>' + response.id + '</td><td> ' + response.description + '</td><td>Sí</td><th><input type="button" value="Listo" onclick="updateTask({{$task -> id}})"></th><td><input type="button" value="eliminar" onclick="deleteTask({{$task -> id}})"></td>');
